...
for(org in c('arabidopsis','yeast', 'zebrafish','human')){
    ...
    load(paste0("data/", org, "/LCS/lcs_p1.rdata"))
    load(paste0("data/", org, "/LCS/lcs_p2.rdata"))
    load(paste0("data/", org, "/LCS/lcs_p3.rdata"))  
    ...
    load(paste0("data/", org, "/LCS/lcs_n1.rdata"))
    load(paste0("data/", org, "/LCS/lcs_n2.rdata"))
    load(paste0("data/", org, "/LCS/lcs_n3.rdata")) 
    ...
    save(lcs_both_strands, lcs_pos_strand, file=paste0("data/",org, "/LCS/lcs_data_summary.rdata"))
}
